...
namespace Lecture_EF_Advanced_Querying.Models
{
    public partial class MusicXContext : DbContext
    {
        ...
        ////towa e nqkakyv preudo cod na modification-a, za da ne se triqt fizicheski zapisite, a samo
        ////da se markirat kato iztriti:
        //public override int SaveChanges()
        //{
        //    var items = this.ChangeTracker.Entries().Where(x => x.State == EntityState.Deleted);
        //    foreach (var item in items)
        //    {
        //        item.State = EntityState.Modified;
        //        if (item.Entity is IDeletable deletable)
        //        {
        //            deletable.IsDeleted = true;
        //            //posle kato dyrpam danni, za da vizualiziram samo tezi, koito NE SA iztriti, trqbwa
        //            //vinagi v Select()-a na tazi danni da vlizat samo takiwa, koito sa s IsDeleted = false, t.e
        //            //trqbwa da sloja WHERE IsDelted IS NOT true.
        //        }
        //    }
        //}
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder
                    ...
                    //.UseLazyLoadingProxies(); //za Lazy Loading
            }
        }
